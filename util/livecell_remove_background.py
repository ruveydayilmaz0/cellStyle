...
root = "/netshares/BiomedicalImageAnalysis/Resources/CellTrackingChallenge_UlmanNMeth/2024/BF-C2DL-MuSC/"
root_images = root + "01/"
root_semantics = root + "01_ST/SEG/"
save_path = "/netshares/BiomedicalImageAnalysis/Resources/CellTrackingChallenge_UlmanNMeth/2024/BF-C2DL-MuSC_backRemoved/01/"
...
for img_path in img_paths:
    ...
    try:
        ...
        continue
    background = np.clip(np.random.normal(mean, std_dev, (img.shape)), 1, 10).astype(
        np.uint8
    )
