...
class style_transfer_module:
    ...
    def get_text_condition(self, text):
        ...
        denoise_kwargs = {"encoder_hidden_states": torch.cat(text_cond)}
    ...
    def reverse_process(self, input, denoise_kwargs):
        ...
        for t in tqdm(self.scheduler.timesteps):
            ...
            with torch.no_grad():
                ...
                pred_original_sample = scheduler.step(
                    noisy_residual, t, input
...
if __name__ == "__main__":
    ...
    if cfg.without_init_adain:
        ...
        latent_cs = (content_latent - content_latent.mean(dim=(2, 3), keepdim=True)) / (
            content_latent.std(dim=(2, 3), keepdim=True) + 1e-4
        ) * style_latent.std(dim=(2, 3), keepdim=True) + style_latent.mean(
