...
sty: '/netshares/BiomedicalImageAnalysis/Resources/dataset_collection/PanNuke/small_sample/01/'
...
precision: 'autocast'
output_path: '/work/scratch/yilmaz/transferred_styles/CTC_n2dl_hela_zoom0_pannuke/'
